 ...
 * Omid Reza Zarei - test@gmail.com
 * Farhad Rad - sir.stranger.aq@gmail.com
 * Under MIT license 
 * July 2021
 * 
 * 
...
var persianDate = __webpack_require__(1);
...
var TimeSpan = function () {
    ...
    _createClass(TimeSpan, [{
        key: 'parseMilliseconds',
        value: function parseMilliseconds(milliseconds) {
            var now = new Date(),
        ...
        key: 'toString',
        value: function toString(pattern) {
        ...
        key: 'toPersianString',
        value: function toPersianString(pattern) {
            if (typeof pattern === "undefined") {
                pattern = "";
        ...
        value: function getAgeObject() {
            ...
            return { reverse: reverse, years: years, months: months, days: days };
        }
    }, {
        key: 'getPersianAgeObject',
        value: function getPersianAgeObject() {
            var end = this._end,
                start = this._start,
                reverse = false;
...
module.exports = function () {
    var TimeSpan = __webpack_require__(0);
...
module.exports = function () {
    ...
    /**
     * Calculates TimeSpan From Base Number Milliseconds Ago
     * @returns {TimeSpan}
     */
    Number.prototype.toTimeSpan = function () {
        var timeSpan = new TimeSpan(new Date());
        return timeSpan.parseMilliseconds(this);
    };
...
module.exports = function () {
    ...
    Object.prototype.toFormData = function () {
        ...
        var binder = function binder(data, parentKey) {
            if (data && (typeof data === 'undefined' ? 'undefined' : _typeof(data)) === 'object' && !(data instanceof Date) && !(data instanceof File)) {
